...
export declare class StripeInstance implements StripeServiceInterface {
    ...
    verifyMicrodepositsForSetup(clientSecret: string, data?: VerifyMicrodepositsForSetupData): Observable<PaymentIntentResult>;
