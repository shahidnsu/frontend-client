...
export declare class StripePaymentElementComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StripePaymentElementComponent, "ngx-stripe-payment", never, { "containerClass": "containerClass"; "options": "options"; "elementsOptions": "elementsOptions"; "stripe": "stripe"; "appearance": "appearance"; "clientSecret": "clientSecret"; "doNotCreateUntilClientSecretIsSet": "doNotCreateUntilClientSecretIsSet"; }, { "load": "load"; "blur": "blur"; "change": "change"; "focus": "focus"; "ready": "ready"; "escape": "escape"; "loaderror": "loaderror"; }, never, never, true, never>;
}
