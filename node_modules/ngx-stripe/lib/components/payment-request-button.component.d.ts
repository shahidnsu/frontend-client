...
export declare class StripePaymentRequestButtonComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StripePaymentRequestButtonComponent, "ngx-stripe-payment-request-button", never, { "containerClass": "containerClass"; "paymentOptions": "paymentOptions"; "options": "options"; "elementsOptions": "elementsOptions"; "stripe": "stripe"; }, { "load": "load"; "change": "change"; "blur": "blur"; "focus": "focus"; "ready": "ready"; "token": "token"; "paymentMethod": "paymentMethod"; "source": "source"; "cancel": "cancel"; "shippingaddresschange": "shippingaddresschange"; "shippingoptionchange": "shippingoptionchange"; "notavailable": "notavailable"; }, never, never, true, never>;
}
