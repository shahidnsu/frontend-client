...
export declare class StripeCardNumberComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<StripeCardNumberComponent, [null, { optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<StripeCardNumberComponent, "ngx-stripe-card-number", never, { "containerClass": "containerClass"; "options": "options"; }, { "load": "load"; "blur": "blur"; "change": "change"; "focus": "focus"; "ready": "ready"; "escape": "escape"; }, ["loadingTemplate"], never, true, never>;
}
