...
declare type NgxStripeCardGroupChangeEvent = StripeCardNumberElementChangeEvent | StripeCardExpiryElementChangeEvent | StripeCardCvcElementChangeEvent;
declare type NgxStripeCardGroupElements = StripeCardNumberElement | StripeCardExpiryElement | StripeCardCvcElement;
export declare class StripeCardGroupDirective implements OnInit, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<StripeCardGroupDirective, "ngx-stripe-card-group,[ngxStripeCardGroup]", never, { "elementsOptions": "elementsOptions"; "stripe": "stripe"; }, { "elements": "elements"; "load": "load"; "blur": "blur"; "change": "change"; "focus": "focus"; "ready": "ready"; "escape": "escape"; }, never, never, true, never>;
}
export {};
